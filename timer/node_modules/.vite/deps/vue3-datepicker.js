...
var formatDistance_default2 = convertToFP(formatDistance3, 2);
...
var formatDistanceWithOptions_default = convertToFP(formatDistance3, 3);
...
var formatRelative_default2 = convertToFP(formatRelative3, 2);

// node_modules/date-fns/esm/fp/formatRelativeWithOptions/index.js
var formatRelativeWithOptions_default = convertToFP(formatRelative3, 3);
  ...
  return openBlock(), createBlock(
    ...
    [
      ...
      createVNode("div", _hoisted_4, [
        "subheading" in _ctx.$slots ? (openBlock(), createBlock(
          Fragment,
          { key: 0 },
          [
...
var script$3 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const months2 = computed(() => eachMonthOfInterval({
      start: from.value,
      end: to.value
    }).map((value) => ({
      value,
...
var script$2 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const weekDays = computed(() => {
      ...
      return Array.from(Array(7)).map((_, i2) => (initial + i2) % 7).map((v) => setDay(/* @__PURE__ */ new Date(), v, {
        weekStartsOn: props.weekStartsOn
      })).map(dayFormat);
    });
...
var render$1 = _withId((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return openBlock(), createBlock(_component_picker_popup, {
    ...
    heading: _withId(() => [
      createTextVNode(
        toDisplayString(_ctx.padStartZero(_ctx.hours)) + ":" + toDisplayString(_ctx.padStartZero(_ctx.minutes)),
        1
        /* TEXT */
      )
    ]),
      ...
      createVNode(
        ...
        [
          (openBlock(true), createBlock(
            Fragment,
            null,
            renderList(_ctx.hoursList, (item) => {
              return openBlock(), createBlock("button", {
                key: item.value,
                ref: item.ref,
                class: { selected: item.selected },
                ...
                createVNode(
                  "span",
                  null,
                  toDisplayString(_ctx.padStartZero(item.value)),
                  1
                  /* TEXT */
                )
              ], 10, ["disabled", "onClick"]);
      ...
      createVNode(
        ...
        [
          (openBlock(true), createBlock(
            Fragment,
            null,
            renderList(_ctx.minutesList, (item) => {
              return openBlock(), createBlock("button", {
                key: item.value,
                ref: item.ref,
                class: { selected: item.selected },
...
var script = defineComponent({
  ...
  setup(props, { emit, attrs }) {
    ...
    const pageDate = ref(/* @__PURE__ */ new Date());
    const inputRef = ref(null);
    const input = ref("");
    watchEffect(() => {
      const parsed = parse(input.value, props.inputFormat, /* @__PURE__ */ new Date());
      if (isValid(parsed)) {
    ...
    const keyUp = (event) => {
      ...
      if (props.typeable) {
        const parsedDate = parse(inputRef.value.value, props.inputFormat, /* @__PURE__ */ new Date(), { locale: props.locale });
...
export {
  vue3_datepicker_esm_default as default
};
